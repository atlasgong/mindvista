        ...
        <section className="mb-16">
            ...
            <div className="flex flex-wrap justify-center gap-8">
                {props.members.map((member) => (
                    <div key={member.name} className="flex w-full flex-col items-center rounded-xl bg-cBackgroundOffset p-6 text-center shadow-lg sm:w-[calc(50%-1rem)] lg:w-[calc(33.333%-1.34rem)]">
