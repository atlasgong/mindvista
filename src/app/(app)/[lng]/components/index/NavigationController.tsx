...
export default function NavigationController({ lng }: { lng: Language }) {
...
import { Language } from "@/app/(app)/i18n/settings";

function LandingNavBarDesktop({ lng }: { lng: Language }) {
    const socialLinks = [
        {
