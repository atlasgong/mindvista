...
export default function ThemeIcon() {
    ...
    return (
        <button id="themeToggle" className={`border-0 bg-none transition-opacity duration-200 ${isInCooldown ? "cursor-not-allowed opacity-50" : "opacity-100"}`} onClick={handleToggleClick} disabled={isInCooldown} aria-label="Toggle site to light or dark mode.">
